  ...
  context( 'Primitives', function()
    ...
    for _,primitive in pairs(primitives) do
      ...
      context('A ' .. theType, function()
        ...
        test('it should make instanceOf return false', function()
          assert_false(f1())
          assert_false(f2())
          assert_false(f3())
        end)
