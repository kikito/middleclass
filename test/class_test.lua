context( 'class', function()
  ...
  context( 'When creating a class', function()
    ...
    context( 'using class("name")', function()
      ...
      test( 'it should have the correct name', function()
        assert_equal(TheClass.name, 'TheClass')
      end)

      test( 'it should have Object as their superclass', function()
    ...
    context( 'using class("name", AClass)', function()
      ...
      test( 'it should have the correct superclass', function()
